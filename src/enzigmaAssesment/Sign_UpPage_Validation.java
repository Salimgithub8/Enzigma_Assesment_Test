...
public class Sign_UpPage_Validation extends BaseClass {
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		wait2.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@name='firstName']")));
		 ...
		 f_name.sendKeys("Akash");driver.findElement(By.xpath("//input[@name='lastName']")).sendKeys("Mogal");
		driver.findElement(By.xpath("//input[@name='password']")).sendKeys("Salim@88");
		driver.findElement(By.xpath("//input[@name='password-confirmpassword']")).sendKeys("Salim@88");
		driver.findElement(By.xpath("//abx-button[@name='register']")).click();
		postCondition();
...
////		// note-here we verify the code manually
		...
		driver.findElement(By.xpath("(//input[@class='slds-input ng-untouched ng-pristine ng-valid'])[3]")).sendKeys("salimmogal123gmail.com");
		...
		stop.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@name='firstName']")));
		 ...
		 f_name111.sendKeys("Akash");driver.findElement(By.xpath("//input[@name='lastName']")).sendKeys("Mogal");
		driver.findElement(By.xpath("(//input[@name='password'])[2]")).sendKeys("Salim@88");
		driver.findElement(By.xpath("//input[@name='password-confirmpassword']")).sendKeys("Salim@88");
